...
setup/dictionary-de/olaph_de.txt -- the same OLaPh corpus + parser
(setup/dictionary-common/olaph_parse.py) the compressed dictionary
(CompactOlaphDE_data.h) is built from, so this model's training data
...
DEFAULT_INPUT = HERE.parent / "dictionary-de" / "olaph_de.txt"
