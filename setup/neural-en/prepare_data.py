...
setup/dictionary-en/cmudict_dump.txt (word<TAB>PHONEMES, stress digits kept --
the same dump setup/dictionary-en/'s pipeline uses, regenerate with
`setup/dictionary-en/dump_cmudict.cpp` if it's stale).
...
DEFAULT_INPUT = HERE.parent / "dictionary-en" / "cmudict_dump.txt"
...
def main():
    ...
    if not args.input.exists():
        ...
        print("  cd ../dictionary-en && g++ -std=c++17 -O2 -I ../../src dump_cmudict.cpp -o /tmp/dump_cmudict")
