...
setup/dictionary-fr/olaph_fr.txt -- the same OLaPh corpus + parser
(setup/dictionary-common/olaph_parse.py) the compressed dictionary
(CompactOlaphFR_data.h) is built from, so this model's training data
...
DEFAULT_INPUT = HERE.parent / "dictionary-fr" / "olaph_fr.txt"
